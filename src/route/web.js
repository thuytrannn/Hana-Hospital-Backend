...
let initWebRoutes = (app) => {
    ...
    router.get('/api/get-chedule-doctor-by-date', doctorController.getScheduleDoctorByDate)
    ...
    router.post('/api/verify-book-appointment', patienController.postVerifyBookAppointment)

    router.post('/api/create-new-specialty', specialtyController.createNewSpecialty)
    router.post('/api/save-infor-specialty', specialtyController.saveInforSpecialty)
    router.get('/api/get-all-specialties', specialtyController.getAllSpecialties)
    router.get('/api/get-detail-specialty-by-id', specialtyController.getDetailSpecialtyById)

    router.post('/api/create-new-clinic', clinicController.createNewClinic)
    router.post('/api/save-infor-clinic', clinicController.saveInforClinic)
